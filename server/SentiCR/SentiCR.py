...
with open("server/SentiCR/Contractions.txt","r") as contractions,\
     open("server/SentiCR/EmoticonLookupTable.txt","r") as emotable:
...
class SentiCR:
    ...
    def read_data_from_oracle(self):
        workbook = open_workbook("server/SentiCR/oracle.xlsx")
